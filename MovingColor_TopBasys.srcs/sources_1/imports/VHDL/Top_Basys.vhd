...
-----------------------------------------------------------------------------------------
	...
	-- Sélection de l'Entrée ? Utiliser pour l'Encodeur Rotatif
	...
	accelero_mgr : entity work.accelero_mgr(Behavioral) 
			...
			port map( 
             ...
             -- Accelerometer data signals
				own_acc_left	=> own_acc_left,	-- Commande de Déplacement ? Gauche
				own_acc_right	=> own_acc_right,	-- Commande de Déplacement ? Droite
...
------------------------------------------------------------------
	...
	game_ctrl: entity work.game
			port map (
				...
				pause_rqt 			=> Centre,					-- Demande de Pause - Appui sur Bouton Encodeur
